...
const Contact = () => {
  return (
    <div>
      <section className="min-h-screen bg-gradient-to-r from-rgb(17 24 39) via-rgb(17 24 39) to-rgb(17 24 39) dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
